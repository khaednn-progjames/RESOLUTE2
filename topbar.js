...
`;
  ...
  const CMDK_COMMANDS = [
    ...
    { group: 'Pages', ic: '❤️', label: 'Health',          sub: 'meals & water',      href: 'health.html',       kw: 'health meals food calories water' },
    { group: 'Pages', ic: '💊', label: 'Supplements',     sub: 'daily stack',        href: 'supplements.html',  kw: 'supplements stack vitamins pills creatine' },
